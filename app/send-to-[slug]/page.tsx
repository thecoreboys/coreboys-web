    ...
    <div className="fan-mail-shell relative min-h-screen pb-32">
      <header className="px-6 pb-8 pt-24 md:px-16 md:pb-12 md:pt-32">
        <div className="mx-auto max-w-[640px]">
          <Link
            ...
            className="mb-6 inline-flex items-center gap-1 font-mono text-xs uppercase tracking-[0.22em] text-[color:var(--ink-faint)] hover:text-[color:var(--ink)]"
          >
      ...
      <section className="px-6 md:px-16">
        <div className="mx-auto max-w-[640px]">
          ...
          <p className="mt-8 text-center text-xs text-[color:var(--ink-faint)]">
          ...
          <div className="mt-8 flex justify-center">
            <Link
              href={"/fan-mail" as Route}
              className="font-mono text-xs uppercase tracking-[0.22em] text-[color:var(--ink-dim)] hover:text-[color:var(--core)]"
            >
