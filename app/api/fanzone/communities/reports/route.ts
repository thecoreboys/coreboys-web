...
import { CommunityInputError, CommunityRateLimitError, reportCommunityItem } from "@/lib/fanzone-communities";
...
const Body = z.object({
  ...
  reason: z.enum(["privacy", "copyright", "unsafe", "spam", "harassment", "other"]),
...
export async function POST(request: Request) {
  ...
  try {
    await reportCommunityItem(userId, parsed.data);
