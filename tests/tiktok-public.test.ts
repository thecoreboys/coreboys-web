...
const profileHtml = `
  <script type="application/json" id="__UNIVERSAL_DATA_FOR_REHYDRATION__">
    {"scope":{"items":[
      {"id":"7521412345678901234","desc":"new CORE moment","createTime":1750000000,"author":{"uniqueId":"officialcoreboys"},"video":{"cover":"https://p16-sign.tiktokcdn-us.com/cover.jpg","width":1080,"height":1920}},
