 ...
 * live in Cloudflare R2. The local `public/{members,crew,group,
 ...
 *
 * The loader rewrites known CDN-prefixed paths to their media-domain URL.
 ...
 * web-friendly (JPEG / PNG, sane dimensions) and Cloudflare handles
...
export default function imageLoader({ src }: LoaderArgs): string {
  ...
  // R2-hosted prefixes get rewritten to the public media domain.
