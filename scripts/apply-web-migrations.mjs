...
const migrations = [
  ...
  "035_supporter_billing_controls.sql",
  "036_core_originals_webp_posters.sql",
  "037_dj_cora_joke_book.sql",
  "038_logo_submissions.sql",
  "039_social_profile_image_cache.sql",
  ...
  "045_supporter_billing_guardrails.sql",
  "046_supporter_checkout_and_webhook_ordering.sql",
