    ...
    <section className="border-t border-[color:var(--rule)] bg-[color:var(--bg)]">
      <div className="mx-auto max-w-[1440px] px-6 py-16 md:px-8 md:py-24">
        <header className="mb-10 flex flex-wrap items-end justify-between gap-4">
          ...
          <Link
            href="/news"
            className="inline-flex items-center gap-1 text-[13px] font-medium text-[color:var(--ink-dim)] transition-colors hover:text-[color:var(--ink)]"
          >
              ...
              >
                {a.image ? (
                  <span className="relative block aspect-[16/10] w-full overflow-hidden bg-black media-tone">
                    ...
                    />
                    <span className="absolute left-3 top-3 inline-flex items-center gap-1.5 tag">
                      {a.category}
                    </span>
                  </span>
                ) : null}
                ...
                <div className="flex flex-1 flex-col gap-3 p-5">
                  ...
                  <h3 className="text-balance text-[18px] font-semibold leading-snug tracking-tight text-[color:var(--ink)] group-hover:text-[color:var(--ink)]">
                    {a.title}
                  </h3>
