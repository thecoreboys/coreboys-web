/**
 * Inline platform glyphs — just the marks, no wordmarks. Used as
 * watermarks on clip cards + filter chips so the platform reads as
 * a logo rather than a text label.
 */

type Platform = "twitch" | "youtube" | "tiktok" | "instagram" | "x";
