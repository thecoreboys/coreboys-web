  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 flex flex-col items-end gap-1.5 md:bottom-6 md:right-6">
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 rounded-full border border-[color:var(--rule)] bg-[color:var(--bg-elev)]/85 px-3 py-1.5 font-mono text-[10px] uppercase tracking-[0.2em] text-[color:var(--ink-dim)] backdrop-blur-md transition-colors hover:border-[color:var(--core)] hover:text-[color:var(--core)]"
      >
        Built by MDCran ↗
      </a>
    </div>
